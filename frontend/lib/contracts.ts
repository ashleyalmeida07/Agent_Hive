...
import { apiEscrowAbi } from "./abi/api-escrow";
...
export const API_ESCROW_ADDRESS = (process.env.NEXT_PUBLIC_API_ESCROW || "0x0000000000000000000000000000000000000000") as Address;
